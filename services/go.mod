module github.com/ymotongpoo/otel-platform-blueprint/services

go 1.26.5

replace github.com/ymotongpoo/otel-platform-blueprint/sdk => ../sdk

require (
	github.com/ymotongpoo/otel-platform-blueprint/sdk v0.0.0-00010101000000-000000000000
